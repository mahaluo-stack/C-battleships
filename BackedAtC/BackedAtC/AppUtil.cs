...
namespace BackedAtC
{
    public static class AppUtil
    {
        ...
        {
            PropertyDescriptorCollection props = TypeDescriptor.GetProperties(typeof(T)); DataTable dt = new DataTable(); dt.TableName = "wsTable";
            //web service table            
            ...
            for (int i = 0; i < props.Count; i++)
            {
                ...
                //one of the properties of class T                
                dt.Columns.Add(pd.Name, pd.PropertyType);
                //new column of property name                                                    
